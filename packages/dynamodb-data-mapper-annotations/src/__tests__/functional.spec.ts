import { Author, Comment, Post } from './fixtures/ExampleSchema.fixture';
import { DataMapper, DynamoDbSchema } from '@invisit/dynamodb-data-mapper';
import { isSchema } from '@invisit/dynamodb-data-marshaller';
