...
import {equals} from '@invisit/dynamodb-expressions';
...
it will be serialized using the `@invisit/dynamodb-auto-marshaller` package.
...
// you can also define an equality predicate with the `equals` helper method
import {notEquals} from '@invisit/dynamodb-expressions';
...
// you can also define an equality predicate with the `equals` helper method
import {lessThan} from '@invisit/dynamodb-expressions';
...
// you can also define an equality predicate with the `equals` helper method
import {lessThanOrEqualTo} from '@invisit/dynamodb-expressions';
...
// you can also define an equality predicate with the `equals` helper method
import {greaterThan} from '@invisit/dynamodb-expressions';
...
// you can also define an equality predicate with the `equals` helper method
import {greaterThanOrEqualTo} from '@invisit/dynamodb-expressions';
...
// you can also define an equality predicate with the `equals` helper method
import {between} from '@invisit/dynamodb-expressions';
...
is received, it will be serialized using the `@invisit/dynamodb-auto-marshaller`
package.
...
// you can also define an equality predicate with the `equals` helper method
import {inList} from '@invisit/dynamodb-expressions';
...
by the `@invisit/dynamodb-auto-marshaller` package's `Marshaller`):
...
```typescript
import {MathematicalExpression} from '@invisit/dynamodb-expressions';
