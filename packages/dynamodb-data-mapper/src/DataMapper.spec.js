...
describe('DataMapper', function () {
    ...
    describe('#batchDelete', function () {
        ...
        var _loop_1 = function (asyncInput) {
            it('should should partition delete batches into requests with 25 or fewer items', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var deletes, expected, i, input, _a, _b, deleted, e_2_1, calls;
                var e_2, _c;
                return tslib_1.__generator(this, function (_d) {
                    switch (_d.label) {
                            ...
                            input = asyncInput
                                ? function () {
                                    return tslib_1.__asyncGenerator(this, arguments, function () {
                                        var deletes_1, deletes_1_1, item, e_3_1;
                                        var e_3, _a;
                        ...
                        case 1:
                            ...
                            _a = tslib_1.__asyncValues(mapper.batchDelete(input));
                            _d.label = 2;
            ...
            it('should should retry unprocessed items', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var deletes, i, failures, _loop_2, failures_1, failures_1_1, failureId, input, _a, _b, deleted, e_4_1, calls, callCount, i;
                var e_5, _c;
                var e_4, _d;
                    ...
                    switch (_e.label) {
                        case 0:
                            ...
                            try {
                                ...
                                try {
                                    if (failures_1_1 && !failures_1_1.done && (_c = failures_1.return)) _c.call(failures_1);
                                }
                            ...
                            input = asyncInput
                                ? function () {
                                    return tslib_1.__asyncGenerator(this, arguments, function () {
                                        var deletes_2, deletes_2_1, item, e_6_1;
                                        var e_6, _a;
                                        return tslib_1.__generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                        ...
                        case 12:
                            ...
                            callCount = calls.reduce(function (keyUseCount, _a) {
                                ...
                                try {
                                    for (var _d = tslib_1.__values(foo), _e = _d.next(); !_e.done; _e = _d.next()) {
                                        var key = _e.value.DeleteRequest.Key.fizz.N;
    ...
    describe('#batchGet', function () {
        ...
        it('should allow setting an overall read consistency', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.trys.push([1, 6, 7, 12]);
                        _a = tslib_1.__asyncValues(mapper.batchGet(gets, { readConsistency: 'strong' }));
                        _d.label = 2;
                    case 2: return [4 /*yield*/, _a.next()];
                    case 3:
                        if (!(_b = _d.sent(), !_b.done)) return [3 /*break*/, 5];
        ...
        it('should allow setting per-table read consistency', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var gets, config, _a, _b, _2, e_10_1;
            var _c;
            var e_10, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        gets = [
                            ...
                            (_c = {
                                ...
                                _c[protocols_1.DynamoDbTable] = 'bar',
                                _c[protocols_1.DynamoDbSchema] = {
                                    quux: {
                                        type: 'Number',
                                        keyType: 'HASH',
                                    }
                    ...
                    case 1:
                        _e.trys.push([1, 6, 7, 12]);
                        _a = tslib_1.__asyncValues(mapper.batchGet(gets, config));
                        _e.label = 2;
                    case 2: return [4 /*yield*/, _a.next()];
                    case 3:
                        if (!(_b = _e.sent(), !_b.done)) return [3 /*break*/, 5];
        ...
        it('should allow specifying per-table projection expressions', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var gets, config, _a, _b, _3, e_11_1;
            var _c;
            var e_11, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
        ...
        var _loop_3 = function (asyncInput) {
            it('should should partition get batches into requests with 100 or fewer items', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var gets, expected, responses, i, _loop_4, responses_1, responses_1_1, response, input, _a, _b, item, e_12_1, calls;
                var e_13, _c;
                var e_12, _d;
                return tslib_1.__generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            input = asyncInput
                                ? function () {
                                    return tslib_1.__asyncGenerator(this, arguments, function () {
                                        var gets_1, gets_1_1, item, e_14_1;
                                        var e_14, _a;
                                        return tslib_1.__generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                        ...
                        case 1:
                            _e.trys.push([1, 6, 7, 12]);
                            _a = tslib_1.__asyncValues(mapper.batchGet(input));
                            _e.label = 2;
                        case 2: return [4 /*yield*/, _a.next()];
                        case 3:
                            if (!(_b = _e.sent(), !_b.done)) return [3 /*break*/, 5];
            ...
            it('should should retry unprocessed items', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var failures, gets, expected, responses, currentRequest, i, response, _loop_5, responses_2, responses_2_1, response, input, itemsReturned, _a, _b, item, e_15_1, calls, callCount, i;
                var e_16, _c;
                var e_15, _d;
                return tslib_1.__generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            try {
                                ...
                                try {
                                    if (responses_2_1 && !responses_2_1.done && (_c = responses_2.return)) _c.call(responses_2);
                                }
                            ...
                            input = asyncInput
                                ? function () {
                                    return tslib_1.__asyncGenerator(this, arguments, function () {
                                        var gets_2, gets_2_1, item, e_17_1;
                                        var e_17, _a;
                                        return tslib_1.__generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                        ...
                        case 12:
                            ...
                            callCount = calls.reduce(function (keyUseCount, _a) {
                                ...
                                try {
                                    for (var _d = tslib_1.__values(Keys), _e = _d.next(); !_e.done; _e = _d.next()) {
                                        var key = _e.value.fizz.N;
                                        if (key in keyUseCount) {
                                            keyUseCount[key]++;
                                        }
                                        else {
    ...
    describe('#batchPut', function () {
        ...
        var _loop_6 = function (asyncInput) {
            it('should should partition put batches into requests with 25 or fewer items', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var puts, expected, i, input, _a, _b, item, e_20_1, calls;
                var e_20, _c;
                return tslib_1.__generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            input = asyncInput
                                ? function () {
                                    return tslib_1.__asyncGenerator(this, arguments, function () {
                                        var puts_1, puts_1_1, item, e_21_1;
                                        var e_21, _a;
                                        return tslib_1.__generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                        ...
                        case 1:
                            _d.trys.push([1, 6, 7, 12]);
                            _a = tslib_1.__asyncValues(mapper.batchPut(input));
                            _d.label = 2;
                        case 2: return [4 /*yield*/, _a.next()];
                        case 3:
                            if (!(_b = _d.sent(), !_b.done)) return [3 /*break*/, 5];
            ...
            it('should should retry unprocessed items', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var puts, i, item, failures, _loop_7, failures_2, failures_2_1, failureId, input, _a, _b, item, e_22_1, calls, callCount, i;
                var e_23, _c;
                var e_22, _d;
                return tslib_1.__generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            try {
                                ...
                                try {
                                    if (failures_2_1 && !failures_2_1.done && (_c = failures_2.return)) _c.call(failures_2);
                                }
                            ...
                            input = asyncInput
                                ? function () {
                                    return tslib_1.__asyncGenerator(this, arguments, function () {
                                        var puts_2, puts_2_1, item, e_24_1;
                                        var e_24, _a;
                                        return tslib_1.__generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                        ...
                        case 12:
                            ...
                            callCount = calls.reduce(function (keyUseCount, _a) {
                                ...
                                try {
                                    for (var _d = tslib_1.__values(foo), _e = _d.next(); !_e.done; _e = _d.next()) {
                                        var key = _e.value.PutRequest.Item.fizz.N;
                                        if (key in keyUseCount) {
                                            keyUseCount[key]++;
                                        }
                                        else {
    ...
    describe('#createGlobalSecondaryIndex', function () {
        var waitPromiseFunc = jest.fn(function () { return Promise.resolve(); });
        var updateTablePromiseFunc = jest.fn(function () { return Promise.resolve({}); });
        var mockDynamoDbClient = {
            config: {},
            updateTable: jest.fn(function () { return ({ promise: updateTablePromiseFunc }); }),
        ...
        it('should make and send an UpdateTable request', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mapper.createGlobalSecondaryIndex(Item, 'DescriptionIndex', {
                            indexOptions: {
    ...
    describe('#createTable', function () {
        ...
        it('should make and send a CreateTable request', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('should forgo invoking the waiter if the table is already active', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should allow enabling streams', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mapper.createTable(Item, {
                            readCapacityUnits: 5,
        ...
        it('should create new table with on-demand capacity mode', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mapper.createTable(Item, {
        ...
        it('should allow enabling sse using AWS managed CMK', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mapper.createTable(Item, {
                            readCapacityUnits: 5,
        ...
        describe('index keys', function () {
            ...
            it('should identify and report index keys', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
            ...
            it('should identify and report index keys with on-demand capacity mode', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, mapper.createTable(IndexedItem, {
                                billingMode: 'PAY_PER_REQUEST',
            ...
            it('should throw if no options were provided for a modeled index', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var options;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    describe('#delete', function () {
        var promiseFunc = jest.fn(function () { return Promise.resolve({ Attributes: {} }); });
        var mockDynamoDbClient = {
            config: {},
        ...
        it('should throw if the item does not provide a schema per the data mapper protocol', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should throw if the item does not provide a table name per the data mapper protocol', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, expect(mapper.delete((_a = {},
        ...
        it('should use the table name specified in the supplied table definition', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var tableName;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should apply a table name prefix provided to the mapper constructor', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        it('should marshall the supplied key according to the schema', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should ignore non-key fields when marshalling the key', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.delete((_a = {
        ...
        it('should apply attribute names when marshalling the key', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.delete((_a = {
        ...
        it('should include a condition expression when the schema contains a version attribute', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.delete((_a = {
        ...
        it('should not include a condition expression when the schema contains a version attribute but the value is undefined', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.delete((_a = {
        ...
        it('should not include a condition expression when the skipVersionCheck input parameter is true', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.delete((_a = {
        ...
        it("should not include a condition expression when the mapper's default skipVersionCheck input parameter is true", function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var mapper;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should combine the version condition with any other condition expression', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.delete((_a = {
        ...
        it('should not include ExpressionAttributeValues when a substitution has not been made', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.delete((_a = {
        ...
        it('should unmarshall any returned attributes', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var result;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should support the legacy call pattern', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should return instances of the correct class', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var Item, result;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('#deleteTable', function () {
        ...
        it('should make and send a DeleteTable request and wait for it to take effect', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe('#ensureGlobalSecondaryIndexExists', function () {
        var waitPromiseFunc = jest.fn(function () { return Promise.resolve(); });
        ...
        mapper.createGlobalSecondaryIndex = jest.fn(function () { return Promise.resolve(); });
        beforeEach(function () {
            mapper.createGlobalSecondaryIndex.mockClear();
        ...
        it('should resolve immediately if the table exists, is active, and the GSI already exists', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mapper.ensureGlobalSecondaryIndexExists(Item, 'DescriptionIndex', {
                            indexOptions: {
                                DescriptionIndex: DescriptionIndex
                            },
                            readCapacityUnits: 5,
                    ...
                    case 1:
                        ...
                        expect(mockDynamoDbClient.waitFor.mock.calls.length).toBe(0);
                        expect(mapper.createGlobalSecondaryIndex.mock.calls.length).toBe(0);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should attempt to create the index if the table exists in the ACTIVE state but the specified index does not exist', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, mapper.ensureGlobalSecondaryIndexExists(Item, 'DescriptionIndex', {
                                indexOptions: {
                                    DescriptionIndex: DescriptionIndex
                                },
                                readCapacityUnits: 5,
                    ...
                    case 1:
                        ...
                        expect(mapper.createGlobalSecondaryIndex.mock.calls.length).toBe(1);
                        expect(mockDynamoDbClient.waitFor.mock.calls.length).toBe(0);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should rethrow if "describeTable" throws a "ResourceNotFoundException"', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var expectedError;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        expectedError = new Error('No such table!');
                        expectedError.name = 'ResourceNotFoundException';
                        describeTablePromiseFunc.mockImplementationOnce(function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
                                throw expectedError;
                            });
                        }); });
                        return [4 /*yield*/, expect(mapper.ensureGlobalSecondaryIndexExists(Item, 'DescriptionIndex', {
                                indexOptions: {
                                    DescriptionIndex: DescriptionIndex
                                },
                                readCapacityUnits: 5,
    ...
    describe('#ensureTableExists', function () {
        ...
        it('should resolve immediately if the table exists and is active', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('should wait for the table to exist if its state is not "ACTIVE"', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        describeTablePromiseFunc.mockImplementationOnce(function () { return Promise.resolve({
        ...
        it('should attempt to create the table if "describeTable" throws a "ResourceNotFoundException"', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var options;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should rethrow any service exception other than "ResourceNotFoundException"', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var options;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('#ensureTableNotExists', function () {
        ...
        it('should resolve immediately if the table does not exist', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        describeTablePromiseFunc.mockImplementationOnce(function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        it('should wait for the table not to exist if its state is not "DELETING"', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        describeTablePromiseFunc.mockImplementationOnce(function () { return Promise.resolve({
        ...
        it('should delete the table if its state is "ACTIVE"', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        describeTablePromiseFunc.mockImplementationOnce(function () { return Promise.resolve({
        ...
        it('should wait for the table to exist if its state is "CREATING", then delete it', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        describeTablePromiseFunc.mockImplementationOnce(function () { return Promise.resolve({
        ...
        it('should wait for the table to exist if its state is "UPDATING", then delete it', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        describeTablePromiseFunc.mockImplementationOnce(function () { return Promise.resolve({
    ...
    describe('#get', function () {
        ...
        it('should request a consistent read if the readConsistency is StronglyConsistent', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.get((_a = {},
        ...
        it('should apply the read consistency provided to the mapper constructor if not supplied to the operation', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var mapper;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should serialize a provided projection expression', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.get((_a = {},
        ...
        it('should unmarshall the response using the table schema', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var result;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
    ...
    describe('#parallelScan', function () {
        ...
        it('should execute multiple requests in parallel when performing a scan with multiple segments', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var segments, keys, index, _loop_8, keys_1, keys_1_1, key, results, result, results_1, results_1_1, res, e_26_1, result_1, result_1_1, scannedItem;
            var e_27, _a, e_28, _b;
            var e_26, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
        ...
        it('should return undefined for lastEvaluatedKey on the paginator', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var paginator, paginator_1, paginator_1_1, _4, e_29_1;
            var e_29, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('should return the current state for all segments', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var iterator, iterator_1, iterator_1_1, _5, e_30_1;
            var e_30, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('should resume from a provided scanState', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var scanState, _a, _b, _6, e_31_1;
            var e_31, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 1:
                        _d.trys.push([1, 6, 7, 12]);
                        _a = tslib_1.__asyncValues(mapper.parallelScan(ScannableItem, 3, { scanState: scanState }));
                        _d.label = 2;
                    case 2: return [4 /*yield*/, _a.next()];
                    case 3:
                        if (!(_b = _d.sent(), !_b.done)) return [3 /*break*/, 5];
    ...
    describe('#put', function () {
        ...
        it('should marshall the supplied item according to the schema', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should include a condition expression and increment the version number when the schema contains a version attribute', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.put((_a = {
        ...
        it('should include a condition expression requiring that no versioned item be present when the schema contains a version attribute but the value is undefined', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, mapper.put((_a = {
        ...
        it('should return the unmarshalled input', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var result;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should return an instance of the provided class', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var Item, result;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('#query', function () {
        ...
        it('should paginate over results and return a promise for each item', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var QueryableItem, results, _a, _b, res, e_32_1, results_2, results_2_1, queriedItem;
            var e_33, _c;
            var e_32, _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.trys.push([1, 6, 7, 12]);
                        _a = tslib_1.__asyncValues(mapper.query(QueryableItem, { foo: 'buzz' }));
                        _e.label = 2;
                    case 2: return [4 /*yield*/, _a.next()];
                    case 3:
                        if (!(_b = _e.sent(), !_b.done)) return [3 /*break*/, 5];
        ...
        it('should allow a condition expression as the keyCondition', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should allow a condition expression predicate in the keyCondition', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should allow a filter expression', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should allow a projection expression', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should allow a start key', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('supports the legacy call pattern', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var iter;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should track usage metadata', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        it('should support detaching the paginator', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var ScannedCount, ConsumedCapacity, paginator, paginator_2, paginator_2_1, page, e_34_1;
            var e_34, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        it('should cease iteration once the limit has been reached', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results, results_3, results_3_1, _7, e_35_1;
            var e_35, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        describe('startKey serialization', function () {
            ...
            it('should not inject default values into the startKey', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var iter;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    describe('#scan', function () {
        ...
        it('should paginate over results and return a promise for each item', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var ScannableItem, results, result, results_4, results_4_1, res, e_36_1, result_2, result_2_1, item;
            var e_37, _a;
            var e_36, _b;
        ...
        it('should allow the page size to be set', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should not use a page size greater than the "limit" parameter', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should not use a page size greater than the "pageSize" parameter', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should cease iteration once the limit has been reached', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var results, results_5, results_5_1, _8, e_38_1;
            var e_38, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        describe('startKey serialization', function () {
            ...
            it('should not inject default properties into the startKey', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var iter;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    describe('updating items', function () {
        ...
        describe('#update', function () {
            ...
            it('should marshall updates into an UpdateItemInput', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var item;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            it('should not remove missing keys when onMissing is "SKIP"', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var item;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            it('should throw an error if no attributes were returned', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var _a;
                return tslib_1.__generator(this, function (_b) {
                    promiseFunc.mockImplementation(function () { return Promise.resolve({}); });
            ...
            describe('version attributes', function () {
                ...
                it('should inject a conditional expression requiring the absence of the versioning property and set its value to 0 when an object without a value for it is marshalled', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                    var item;
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                ...
                it('should inject a conditional expression requiring the known value of the versioning property and set its value to the previous value + 1 when an object with a value for it is marshalled', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                    var item;
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
        ...
        describe('#executeUpdateExpression', function () {
            it('should use the provided schema to execute the provided expression', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
