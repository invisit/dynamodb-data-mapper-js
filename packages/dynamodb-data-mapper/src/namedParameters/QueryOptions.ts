...
import type { ConditionExpression, ConditionExpressionPredicate, ProjectionExpression } from "@invisit/dynamodb-expressions"
...
export interface QueryCountOptions extends ReadConsistencyConfiguration {
  /**
...
export interface QueryOptions extends ReadConsistencyConfiguration {
  ...
  select?: undefined | "ALL" | "COUNT" | "ALL_PROJECTED_ATTRIBUTES" | "ALL_ATTRIBUTES"
